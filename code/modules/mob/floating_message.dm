...
/atom/movable/proc/animate_chat(message, datum/language, small, list/show_to, duration)
	set waitfor = FALSE
	...
	var/image/gibberish = language ? generate_floating_text(src, scramble(message), style, fontsize, duration, show_to) : understood
