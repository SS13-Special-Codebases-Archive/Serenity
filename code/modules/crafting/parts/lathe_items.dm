...
/obj/item/cylinder
	...
	mill(var/mob/user)
		switch(chambers)
			if(0)
				if (user.skillcheck(user.skills["crafting"], 30, "You mill to far into the cynlinder, and it falls apart", "crafting"))
					return /obj/item/cylinder/one_slot
			if(1)
				if (user.skillcheck(user.skills["crafting"], 50, "You nick another hole, and the cylinder falls apart.", "crafting"))
					return /obj/item/cylinder/two_slot
			if(2)
				if (user.skillcheck(user.skills["crafting"], 70, "You nick another hole, and the cylinder falls apart.", "crafting"))
					return /obj/item/cylinder/three_slot
			if(3)
				if (user.skillcheck(user.skills["crafting"], 80, "You nick another hole, and the cylinder falls apart.", "crafting"))
