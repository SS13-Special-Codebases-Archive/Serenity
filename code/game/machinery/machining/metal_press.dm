...
/obj/machinery/metal_press/interact(mob/user as mob)
	...
	if(!disabled)
		...
		if (!pressing)
			if (user.skillcheck(user.skills["crafting"], 65, "You try to press the object but it uselessly falls apart.  You don't think this item was meant to be pressed..", "crafting"))
