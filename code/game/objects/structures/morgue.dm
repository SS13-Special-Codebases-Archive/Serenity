...
/obj/structure/morgue
	name = "morgue"
	desc = "Used to keep bodies in until someone fetches, or eats them."
...
/obj/structure/crematorium/proc/cremate(atom/A, mob/user as mob)
	...
	if(contents.len <= 0)
		...
		if(!isemptylist(src.search_contents_for(/obj/item/weapon/disk/nuclear)))
			to_chat(loc, "The button's almost broken status indicator flashes yellow and plays an alarm, indicating that something important is inside the crematorium, and must be removed.")
			return
