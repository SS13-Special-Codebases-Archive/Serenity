...
/obj/item/weapon/implant/imprinting/get_data()
	...
	It is HIGHLY ILLEGAL and the galactic council does NOT endorse use of this device in such way.
	Any amount of the Corporate branded "Mind-Breaker"(TM) present in bloodstream will trigger this side-effect.<BR>"}
